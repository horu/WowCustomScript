...
function cs.stat.Frame.build(self)
  ...
  local button_point = cs.ui.Point:create(0, 0, cs.ui.r.LEFT, self.text:get_native(), cs.ui.r.LEFT)
  self.button = cs.ui.Button:new(40, 15, button_point, nil, nil, function()
